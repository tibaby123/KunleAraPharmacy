...
=======
  ...
  // Placeholder pharmacy images (replace with your actual images later)
  const pharmacyImages = [
    'https://images.unsplash.com/photo-1576671081837-49000212a370?w=1200&h=800&fit=crop&q=80',
    'https://images.unsplash.com/photo-1631549916768-4119b2e5f926?w=1200&h=800&fit=crop&q=80',
    'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=1200&h=800&fit=crop&q=80',
...
<<<<<<< HEAD
            ...
            <div className="flex items-center space-x-3">
              <div className="relative w-48 h-16">
                ...
                />
=======
            {/* Logo - Using text until logo image is added */}
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-2">
                <Package className="h-12 w-12 text-orange-600" />
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Kunle Ara</h1>
...
=======
            ...
            >
              <Shield className="h-5 w-5" />
              <span className="font-semibold">POS Login</span>
>>>>>>> f96f68f (Fix: Working version with all dependencies installed)
            </Link>
          </div>
        </div>
...
=======
      ...
      {/* Just replace the logo image sections with text or icons temporarily */}
...
=======
              <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-orange-100 to-blue-100">
>>>>>>> f96f68f (Fix: Working version with all dependencies installed)
...
<<<<<<< HEAD
      {/* Main Features Grid */}
=======
      {/* Main Features Grid - Keep all your existing feature cards */}
>>>>>>> f96f68f (Fix: Working version with all dependencies installed)
...
=======
              <div className="flex items-center space-x-2 mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold">Kunle Ara</h3>
...
=======
                <li><Link href="/pos" className="hover:text-white">Reports</Link></li>
>>>>>>> f96f68f (Fix: Working version with all dependencies installed)
              </ul>
            </div>
